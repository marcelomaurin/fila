...
begin
    ...
    if  BuscaChave(arquivo,'PORTPAINEL:',posicao) then
    begin
      FPORTPAINEL := RetiraInfo(arquivo.Strings[posicao]);
    end;
    if  BuscaChave(arquivo,'IPFALAR:',posicao) then
    begin
      FIPFALAR := RetiraInfo(arquivo.Strings[posicao]);
    end;
    if  BuscaChave(arquivo,'PORTFALAR:',posicao) then
    begin
      FPORTFALAR := RetiraInfo(arquivo.Strings[posicao]);
    end;
    if  BuscaChave(arquivo,'IPFILA:',posicao) then
    begin
      FIPFILA := RetiraInfo(arquivo.Strings[posicao]);
    end;
    if  BuscaChave(arquivo,'PORTFILA:',posicao) then
    begin
      FPORTFILA := RetiraInfo(arquivo.Strings[posicao]);
    end;
...
begin
  ...
  arquivo.Append('PORTFILA:'+FPORTFILA);
