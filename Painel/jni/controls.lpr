...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 23/03/2021 18:38:11]
...
{ Class:     org_lamw_teste7_Controls
  Method:    pAppOnCreate
...
const NativeMethods: array[0..57] of JNINativeMethod = (
   (name: 'pAppOnCreate';
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/teste7/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_teste7_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_teste7_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_teste7_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_teste7_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_teste7_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_teste7_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_teste7_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_teste7_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_teste7_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_teste7_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_teste7_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_teste7_Controls_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_teste7_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name
    'Java_org_lamw_teste7_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_teste7_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_teste7_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_teste7_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_teste7_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_teste7_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_teste7_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_teste7_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_teste7_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_teste7_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name
    'Java_org_lamw_teste7_Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_teste7_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_teste7_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_teste7_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_teste7_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_teste7_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_teste7_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_teste7_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_teste7_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_teste7_Controls_pOnBackPressed',
  pOnClose name 'Java_org_lamw_teste7_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_teste7_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_teste7_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_teste7_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_teste7_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_teste7_Controls_pOnLostFocus',
  pOnFocus name 'Java_org_lamw_teste7_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_teste7_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name
    'Java_org_lamw_teste7_Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_teste7_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_teste7_Controls_'
    +'pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_org_lamw_teste7_Controls_pOnRunOnUiThread',
  pOnMediaPlayerPrepared name 'Java_org_lamw_teste7_Controls_'
    +'pOnMediaPlayerPrepared',
  pOnMediaPlayerVideoSizeChanged name 'Java_org_lamw_teste7_Controls_'
    +'pOnMediaPlayerVideoSizeChanged',
  pOnMediaPlayerCompletion name 'Java_org_lamw_teste7_Controls_'
    +'pOnMediaPlayerCompletion',
  pOnMediaPlayerTimedText name 'Java_org_lamw_teste7_Controls_'
    +'pOnMediaPlayerTimedText',
  pOnTCPSocketClientMessageReceived name 'Java_org_lamw_teste7_Controls_'
    +'pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientBytesReceived name 'Java_org_lamw_teste7_Controls_'
    +'pOnTCPSocketClientBytesReceived',
  pOnTCPSocketClientConnected name 'Java_org_lamw_teste7_Controls_'
    +'pOnTCPSocketClientConnected',
  pOnTCPSocketClientFileSendProgress name 'Java_org_lamw_teste7_Controls_'
    +'pOnTCPSocketClientFileSendProgress',
  pOnTCPSocketClientFileSendFinished name 'Java_org_lamw_teste7_Controls_'
    +'pOnTCPSocketClientFileSendFinished',
  pOnTCPSocketClientFileGetProgress name 'Java_org_lamw_teste7_Controls_'
    +'pOnTCPSocketClientFileGetProgress',
  pOnTCPSocketClientFileGetFinished name 'Java_org_lamw_teste7_Controls_'
    +'pOnTCPSocketClientFileGetFinished',
  pOnTCPSocketClientDisConnected name 'Java_org_lamw_teste7_Controls_'
    +'pOnTCPSocketClientDisConnected',
  pOnTimer name 'Java_org_lamw_teste7_Controls_pOnTimer';
